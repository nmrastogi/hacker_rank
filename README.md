...
- "Run the screening pipeline for tests 356098 and 2263157" (automatically sends emails and Google Meet invites to top 3)
...
- `run_screening_pipeline` - Run complete screening workflow (includes email sending and Google Meet invites)
